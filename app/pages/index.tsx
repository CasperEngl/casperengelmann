...
const Home = ({ skills }: InferGetStaticPropsType<typeof getStaticProps>) => {
  return (
    <div className="min-h-screen bg-gray-900 space-y-6 lg:space-y-12">
      <section className={'py-16 px-8 container'}>
        <h1 className="text-5xl text-center text-white font-bold uppercase">Casper Engelmann</h1>
        <div
          className={
      ...
      <section className="flex flex-col items-center space-y-4">
        <h2 className="text-gray-700 text-3xl lg:text-7xl font-bold">Socials</h2>
